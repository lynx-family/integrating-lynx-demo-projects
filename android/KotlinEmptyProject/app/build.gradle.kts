...
dependencies {
    ...
    implementation("org.lynxsdk.lynx:lynx-jssdk:3.4.0-rc.0")
    implementation("org.lynxsdk.lynx:lynx-trace:3.4.0-rc.0")
    implementation("org.lynxsdk.lynx:primjs:2.14.0-rc.1")

    // integrating image-service
    implementation("org.lynxsdk.lynx:lynx-service-image:3.4.0-rc.0")
    ...
    implementation("org.lynxsdk.lynx:lynx-service-log:3.4.0-rc.0")

    // integrating http-service
    implementation("org.lynxsdk.lynx:lynx-service-http:3.4.0-rc.0")
